...
def separar_dados(dados):
    ...
    for linha in dados:
        ...
        if contador > 1 and len(linha) >= 5:
            valores_cpu_porcentagem.append(linha[1])
            valores_disco_porcentagem.append(linha[2])
            valores_memoria_porcentagem.append(linha[3])
            valores_data_porcentagem.append(linha[4])   
...
def calcular_metricas(dados_cpu_porcentagem, dados_disco_porcentagem, dados_memoria_porcentagem, dados_data_porcentagem):
    ...
    if tamanho_array == 0:
        print ("Dados insuficientes para o calculo. Aguardando dados")
        return
    ...
    if itens_somados > 0:
        media_memoria_porcentagem = soma_valores_memoria_porcentagem / itens_somados
        media_cpu_porcentagem = soma_valores_cpu_porcentagem / itens_somados
        media_disco_porcentagem = soma_valores_disco_porcentagem / itens_somados
        ...
        print("Dados suficientes para calcular a média.Aguardando dados")
