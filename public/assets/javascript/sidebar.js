...
let btnCloseModalLogout = document.getElementById("cancelar-logout");
let btnConfirmLogout = document.getElementById("confirmar-logout");

btnCloseModalLogout.addEventListener("click", () => {
  modalLogout.close();
});

btnConfirmLogout.addEventListener("click", () => {
  modalLogout.close();
  notification("Aviso", "Encerrando sessão...", 2500);
